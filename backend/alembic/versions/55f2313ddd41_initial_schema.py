...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_facilities_certificate_number"), "facilities", ["certificate_number"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_inspections_facility_id"), "inspections", ["facility_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_inventory_inspection_id"), "inventory", ["inspection_id"], unique=False
    )
    op.create_table(
        "violations",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_violations_inspection_id"), "violations", ["inspection_id"], unique=False
    )
